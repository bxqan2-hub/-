...
class WebUiHelperRegressionTests(unittest.TestCase):
    ...
    def test_accounts_ui_keeps_oaics_actions_without_result_column(self):
        ...
        self.assertIn('id="btnCopyAllCredentialsV2"', html)
        self.assertIn("async function fetchAllAccountIdsForCredentialCopy()", html)
        self.assertIn("async function copyAllAccountPasswordTwoFa", html)
        self.assertIn("bind('btnCopyAllCredentialsV2', copyAllAccountPasswordTwoFa)", html)
