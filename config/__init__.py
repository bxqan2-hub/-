...
from config.proxy import (
    ...
    PROXY_API_RETRY_DELAY,
    PROXY_API_VALIDATE,
    PROXY_API_VALIDATE_TIMEOUT,
    PROXY_API_VALIDATE_CONNECT,
    PROXY_API_VALIDATE_TARGET,
    PROXY_API_VALIDATE_TLS,
    PROXY_API_CACHE_SECONDS,
    ...
    UPI_CHECK_PROXY_PROFILES,
    GCASH_CHECK_PROXY_ACTIVE,
    GOPAY_CHECK_PROXY_ACTIVE,
    MOMO_CHECK_PROXY_ACTIVE,
    UPI_CHECK_PROXY_ACTIVE,
    PAYPAL_OAICS_PROXY_PROFILES,
    PAYPAL_OAICS_PROXY_ACTIVE,
    PAYPAL_OAICS_WORKERS,
    PLAN_CHECK_TIMEOUT,
    ...
    parse_proxy_api_profiles,
    infer_proxy_api_region,
    proxy_region_label,
    get_active_proxy_api_url,
    mask_proxy_url,
...
from config.twofa import (
    ENABLE_2FA,
    TWOFA_OTP_MAX_WAIT,
    TWOFA_OTP_POLL_INTERVAL,
    TWOFA_OTP_SETTLE_SECONDS,
    TWOFA_GENERIC_API_REQUEST_TIMEOUT,
    TWOFA_GENERIC_API_RETRY_TIMEOUT,
    TWOFA_GENERIC_API_MAX_CONSECUTIVE_ERRORS,
)
...
def _refresh_top_level_constants() -> None:
    ...
    from config import browser, openai_protocol, proxy as _proxy, register, email, twofa, roxybrowser, cloakbrowser, browser_use, skyvern, codex, sub2api, humanize, flow_trigger, at_validity
    # 简单粗暴：枚举一遍重要常量，覆盖到 _self
    for src in (browser, openai_protocol, _proxy, register, email, twofa, roxybrowser, cloakbrowser, browser_use, skyvern, codex, sub2api, humanize, flow_trigger, at_validity):
        for k in dir(src):
...
__all__ = [
    ...
    # proxy
    "PROXY_POOL", "PROXY_POOL_ACTIVE", "PROXY_API_ENABLED", "PROXY_API_URL", "PROXY_API_PROFILES", "PROXY_API_ACTIVE", "PROXY_API_PROTOCOL",
    "PROXY_API_TIMEOUT", "PROXY_API_MAX_ATTEMPTS", "PROXY_API_RETRY_DELAY", "PROXY_API_VALIDATE", "PROXY_API_VALIDATE_TIMEOUT",
    "PROXY_API_VALIDATE_CONNECT", "PROXY_API_VALIDATE_TARGET", "PROXY_API_VALIDATE_TLS",
    "PROXY_API_CACHE_SECONDS", "PROXY_API_FAIL_CLOSED",
    "PLAN_CHECK_PROXY_MODE", "PLAN_CHECK_PROXY", "PLAN_CHECK_PROXY_PROFILES", "PLAN_CHECK_PROXY_ACTIVE",
    "AT_VALIDITY_PROXY_PROFILES", "AT_VALIDITY_PROXY_ACTIVE",
    "CHECKOUT_CHECK_PROXY_PROFILES", "CHECKOUT_CHECK_PROXY_ACTIVE",
    "PAYPAL_OAICS_PROXY_PROFILES", "PAYPAL_OAICS_PROXY_ACTIVE", "PAYPAL_OAICS_WORKERS",
    "PLAN_CHECK_TIMEOUT", "PLAN_CHECK_MAX_ATTEMPTS", "PLAN_CHECK_RETRY_DELAY",
    "PLAN_CHECK_WORKERS", "PLAN_CHECK_QUEUE_LIMIT",
    "PLAN_CHECK_MIN_INTERVAL", "PLAN_CHECK_JITTER", "fetch_proxy_from_api",
    "parse_proxy_api_response", "parse_proxy_api_profiles", "infer_proxy_api_region",
    "proxy_region_label", "get_active_proxy_api_url",
    "mask_proxy_url", "validate_proxy_endpoint", "pick_proxy", "PROXY",
    # register
    ...
    # twofa
    "ENABLE_2FA", "TWOFA_OTP_MAX_WAIT", "TWOFA_OTP_POLL_INTERVAL", "TWOFA_OTP_SETTLE_SECONDS",
    "TWOFA_GENERIC_API_REQUEST_TIMEOUT", "TWOFA_GENERIC_API_RETRY_TIMEOUT",
    "TWOFA_GENERIC_API_MAX_CONSECUTIVE_ERRORS",
]
