...
# 注册成功拿到 accessToken 后，保留当前窗口发送一条消息并等待回复，再结束环境。
ROXY_POST_REGISTRATION_CHAT_ENABLED: bool = True
ROXY_POST_REGISTRATION_CHAT_PROMPT: str = "hi"
ROXY_POST_REGISTRATION_CHAT_TIMEOUT: int = 90
