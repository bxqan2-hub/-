...
_RUNTIME_LIST_PATHS = {
    ...
    "MOMO_CHECK_PROXY_PROFILES": _PROJECT_ROOT / "data" / "momo_check_proxy_pool.txt",
    "UPI_CHECK_PROXY_PROFILES": _PROJECT_ROOT / "data" / "upi_check_proxy_pool.txt",
}
_LOADED = False
...
EXPLICIT_EMPTY_LIST_ENV_KEYS = {
    ...
    "GCASH_CHECK_PROXY_PROFILES", "GOPAY_CHECK_PROXY_PROFILES", "MOMO_CHECK_PROXY_PROFILES", "UPI_CHECK_PROXY_PROFILES", "PAYPAL_OAICS_PROXY_PROFILES",
}
...
SECRET_ENV_KEYS: dict[str, str] = {
    ...
    "PROXY_API_URL": "代理 API 地址（可能包含账户标识或鉴权参数）",
