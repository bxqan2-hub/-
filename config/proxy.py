...
# 支付资格检测独立静态代理池；GCash 读取 PH，GoPay 读取 ID，MoMo 读取 VN，UPI 读取 IN。
...
def normalize_exit_ip(value: str | None) -> str:
    """Return a canonical IP literal for preflight/browser route comparisons."""
