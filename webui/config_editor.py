...
EXPLICIT_EMPTY_LIST_KEYS = {
    ...
    "GCASH_CHECK_PROXY_PROFILES", "GOPAY_CHECK_PROXY_PROFILES", "MOMO_CHECK_PROXY_PROFILES", "UPI_CHECK_PROXY_PROFILES",
...
EDITABLE_FIELDS = [
    ...
    {
        "key": "UPI_CHECK_PROXY_PROFILES", "file": "proxy.py", "type": "list_str_multiline", "group": "代理池",
        "label": "UPI 资格代理池（IN）", "help": "UPI 独立印度静态代理池；账号查询 UPI 只使用这里的代理",
        "storage": "runtime_file", "secret": True,
    },
    {
        "key": "UPI_CHECK_PROXY_ACTIVE", "file": "proxy.py", "type": "str", "group": "代理池",
        "label": "UPI 当前国家", "help": "固定为 IN（印度）资格检测出口",
    },
    {
